...
<nav class="flex navbar-main">
        ...
        <label class="navlink" id="navbar-tools">Tools<div class="nav-tooltip tooltip-tools"><ul><li><a href="/tools/clock">Clock</li><li><a href="/tools/charades">Charades</a></li><li><a>HTML Sandbox (viewer)</a></li><li><a href="/tools/color">Random Color Generator</a></li><li><a href="/tools/text">Text Modifiers</a></li><li><a href="/tools/tabflooder">Tab Flooder</a></li><li><a href="/tools/username">Username Generator</a></li><li><a href="/tools/qnotes">Quick Notes</a></li></ul></div></label>
