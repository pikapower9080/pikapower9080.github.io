pyro.addEntityClass("Dragon Boss", {
	...
	actions: {
		...
		shootFireball: function(){
            ...
            stage.layers[stage.spawnPoints[0].layer].addEntity("Fireball", this.position.clone().add(new pyro.Vertex(220,0)), {scale: new pyro.Vertex(1, 1), gravityScale: 0, linearVelocity: new pyro.Vertex(this.logic.memory.ROM.fireballSpeed, 0)})
		}
	},
